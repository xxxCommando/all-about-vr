...
const About = () => (
  ...
  <Layout.Content className="layout-content-article">
    ...
    <section className="about">
      ...
      <p>
        All About VR aims to bring together all the informations about
        VR headsets available on the market in order to consult them in a simple and fast way.
      </p>
      <p>
        You can therefore search or compare headsets, obtain information
        on a specific spec using our Wiki and discover a list of VR games.
      </p>
      ...
      <p>
        As a junior developer, I wanted to do a side project to learn new
      ...
      <p>
        ...
        <a className="link" href="https://github.com/Bleuh/all-about-vr" target="_blank" rel="noopener noreferrer"> github</a>
        .
      </p>
    </section>
  </Layout.Content>
